        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 500px; color: #1c1c1a;">
            ...
            <table style="width: 100%; font-size: 14px; border-collapse: collapse;">
              ...
              <tr><td style="padding: 6px 0; color: #888;">Montant</td><td style="padding: 6px 0; font-weight: 700; color: #1a5c3a;">${price} €</td></tr>${options.length > 0 ? `<tr><td style="padding: 6px 0; color: #888;">Options</td><td style="padding: 6px 0;">${options.includes('RE2020') ? 'RE2020' : ''}</td></tr>` : ''}
            </table>
