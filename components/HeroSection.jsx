  ...
  return (
    <div className="hero" style={{ textAlign: "center", paddingTop: 48, paddingBottom: 24 }}>
      ...
      <p className="hero-subtitle" style={{ fontSize: 16, fontWeight: 400, color: GRAY_500, lineHeight: 1.7, maxWidth: 540, margin: "0 auto 32px" }}>
        Plans sur mesure + dossier complet (déclaration préalable ou permis de construire), prêt à déposer en mairie. Dès 350€, accepté du premier coup ou corrigé gratuitement.
      </p>
